...
# $Header: /var/cvsroot/gentoo-x86/net-libs/gnutls/gnutls-1.0.25.ebuild,v 1.1.1.1 2005/11/30 10:02:50 chriswhite Exp $
...
# gnutls has its own version of these. should maybe avoid using. Done by DEPEND/configure options
#	libtasn1
#	opencdk
