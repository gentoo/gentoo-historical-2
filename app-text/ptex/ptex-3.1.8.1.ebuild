...
# $Header: /var/cvsroot/gentoo-x86/app-text/ptex/ptex-3.1.8.1.ebuild,v 1.1.1.1 2005/11/30 10:06:32 chriswhite Exp $
...
PTEX_PV=3.1.8.1
PTEX_TEXMF_PV=2.3
PTEX_SRC="ptex-src-${PTEX_PV}.tar.gz"
PTEX_TEXMF="ptex-texmf-${PTEX_TEXMF_PV}.tar.gz"
PTETEX=ptetex3-20050315
