...
# $Header: /var/cvsroot/gentoo-x86/app-text/kbibtex/kbibtex-0.1.2-r1.ebuild,v 1.1.1.1 2005/11/30 10:06:39 chriswhite Exp $
...
PATCHES="${FILESDIR}/${P}-strings-fix.patch"
