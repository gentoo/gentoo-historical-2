...
# $Header: /var/cvsroot/gentoo-x86/dev-embedded/avr-libc/avr-libc-1.4.0.ebuild,v 1.1.1.1 2005/11/30 09:53:28 chriswhite Exp $
...
pkg_postinst() {
	ewarn
	ewarn "Please see the file /usr/share/doc/${PF}/NEWS.gz for a list of"
	ewarn "the API changes since ${PN}-1.2.x."
	ewarn
}
