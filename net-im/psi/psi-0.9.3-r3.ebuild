...
# $Header: /var/cvsroot/gentoo-x86/net-im/psi/psi-0.9.3-r3.ebuild,v 1.1.1.1 2005/11/30 10:09:30 chriswhite Exp $
...
src_unpack() {
		...
		if ! use extras ; then
			...
			epatch ${PATCHDIR}/psi-rich_contactview-0.8-add.diff
