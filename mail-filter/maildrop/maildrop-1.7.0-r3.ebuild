...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/maildrop/maildrop-1.7.0-r3.ebuild,v 1.1.1.1 2005/11/30 10:12:02 chriswhite Exp $
...
src_install() {
	...
	for i in makedat makeuserdb pw2userdb userdb userdbpw vchkpw2userdb ; do
		rm -f ${D}/usr/bin/$i
