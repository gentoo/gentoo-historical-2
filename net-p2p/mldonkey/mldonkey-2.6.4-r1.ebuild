...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/mldonkey/mldonkey-2.6.4-r1.ebuild,v 1.1.1.1 2005/11/30 09:51:18 chriswhite Exp $

inherit eutils

IUSE="gtk gtk2 guionly batch threads gd doc mozilla"
