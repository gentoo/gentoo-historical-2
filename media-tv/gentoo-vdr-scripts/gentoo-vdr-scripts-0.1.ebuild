...
# $Header: /var/cvsroot/gentoo-x86/media-tv/gentoo-vdr-scripts/gentoo-vdr-scripts-0.1.ebuild,v 1.1.1.1 2005/11/30 09:50:33 chriswhite Exp $
...
pkg_postinst() {
	...
	einfo
	ewarn "This is the first not alpha release!"
