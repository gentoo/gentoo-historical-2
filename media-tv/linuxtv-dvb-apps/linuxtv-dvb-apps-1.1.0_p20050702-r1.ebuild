...
# $Header: /var/cvsroot/gentoo-x86/media-tv/linuxtv-dvb-apps/linuxtv-dvb-apps-1.1.0_p20050702-r1.ebuild,v 1.1.1.1 2005/11/30 09:50:35 chriswhite Exp $
...
src_unpack()
{
	...
	epatch ${FILESDIR}/${P}-gentoo-install-evtest.patch
