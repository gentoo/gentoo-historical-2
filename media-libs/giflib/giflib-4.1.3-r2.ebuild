...
# $Header: /var/cvsroot/gentoo-x86/media-libs/giflib/giflib-4.1.3-r2.ebuild,v 1.1.1.1 2005/11/30 10:03:46 chriswhite Exp $
...
LICENSE="MIT"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~m68k ~ppc-macos ~ppc64 ~s390 ~sh ~x86"
IUSE="rle X"
