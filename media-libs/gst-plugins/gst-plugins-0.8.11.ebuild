...
# $Header: /var/cvsroot/gentoo-x86/media-libs/gst-plugins/gst-plugins-0.8.11.ebuild,v 1.1.1.1 2005/11/30 10:03:50 chriswhite Exp $
...
RDEPEND=">=media-libs/gstreamer-0.8.11
	>=gnome-base/gconf-2
	!alpha? ( !arm? ( !hppa? ( !ia64? ( !mips? ( !ppc64? (
