...
# $Header: /var/cvsroot/gentoo-x86/media-libs/t1lib/t1lib-5.0.0-r2.ebuild,v 1.1.1.1 2005/11/30 10:04:04 chriswhite Exp $
...
src_compile() {
	...
	econf ${myconf} --datadir=/etc $(use_with X x) || die
	make ${myopt} || die
}
