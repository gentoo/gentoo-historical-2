...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/pango/pango-1.4.1-r1.ebuild,v 1.1.1.1 2005/11/30 09:54:15 chriswhite Exp $
...
src_unpack() {
	...
	use ppc-macos || epatch ${FILESDIR}/${PN}-1.2.2-slighthint.patch
