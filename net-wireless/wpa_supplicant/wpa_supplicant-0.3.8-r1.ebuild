...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/wpa_supplicant/wpa_supplicant-0.3.8-r1.ebuild,v 1.1.1.1 2005/11/30 09:45:28 chriswhite Exp $
...
src_install() {
	...
	newinitd ${FILESDIR}/${PF}-init.d wpa_supplicant || die
	newconfd ${FILESDIR}/${PF}-conf.d wpa_supplicant || die
}
