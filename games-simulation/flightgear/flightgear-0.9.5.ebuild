...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/flightgear/flightgear-0.9.5.ebuild,v 1.1.1.1 2005/11/30 09:49:40 chriswhite Exp $
...
src_install() {
	...
	cp -pPR ${WORKDIR}/data/* "${D}/${GAMES_DATADIR}/${MY_PN}" || die "cp failed"
