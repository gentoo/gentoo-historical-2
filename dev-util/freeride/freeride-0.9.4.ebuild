...
# $Header: /var/cvsroot/gentoo-x86/dev-util/freeride/freeride-0.9.4.ebuild,v 1.1.1.1 2005/11/30 10:05:20 chriswhite Exp $

inherit ruby eutils

DESCRIPTION="FreeRIDE is a pure Ruby Integrated Development Environment."
HOMEPAGE="http://freeride.rubyforge.org/"
SRC_URI="http://rubyforge.org/frs/download.php/3931/${P}.tar.gz"
