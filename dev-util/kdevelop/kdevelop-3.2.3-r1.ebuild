...
# $Header: /var/cvsroot/gentoo-x86/dev-util/kdevelop/kdevelop-3.2.3-r1.ebuild,v 1.1.1.1 2005/11/30 10:05:26 chriswhite Exp $
...
src_unpack() {
	...
	# Fix building of ant projects (kde bug 100813). Applied in 3.5.
