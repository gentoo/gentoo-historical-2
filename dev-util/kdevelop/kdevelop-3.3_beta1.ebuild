...
# $Header: /var/cvsroot/gentoo-x86/dev-util/kdevelop/kdevelop-3.3_beta1.ebuild,v 1.1.1.1 2005/11/30 10:05:26 chriswhite Exp $
...
src_unpack() {
	...
	# qt-3.3.5 patch
	epatch "${FILESDIR}/${PN}-qt-3.3.5.patch"
