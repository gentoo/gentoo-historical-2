...
# $Header: /var/cvsroot/gentoo-x86/dev-util/bazaar/bazaar-1.1.ebuild,v 1.1.1.1 2005/11/30 10:05:32 chriswhite Exp $

S="${WORKDIR}/${P}/src/=build"
DESCRIPTION="Bazaar is a user-interface branch of tla"
SRC_URI="http://bazaar.canonical.com/packages/src/bazaar_${PV}.tar.gz"
