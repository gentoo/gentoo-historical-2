...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/ace/ace-5.4-r2.ebuild,v 1.1.1.1 2005/11/30 09:41:58 chriswhite Exp $
...
# 	ln -s libACE_RMCast.so.${PV} libACE_RMCast.so.`echo ${PV} | cut -f1 -d.`
	...
	#Hmm, 5.4 seems to need the .cpp's?
#	cp -r *.{h,hpp,i,inl} ${D}/usr/include/ace
	cp -r * ${D}/usr/include/ace/
	cp -r os_include ${D}/usr/include/ace/
