...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/swl/swl-0.4.0_rc5-r1.ebuild,v 1.1.1.1 2005/11/30 09:42:18 chriswhite Exp $
...
SRC_URI="http://upstream.trapni-akane.org/swl/${P/_/-}.tar.gz
		 http://upstream.trapni-akane.org/swl/patches/0.4-rc5-post-20050729.diff"
LICENSE="LGPL-2.1"
SLOT="0.4"
