...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pycairo/pycairo-0.1.4.ebuild,v 1.1.1.1 2005/11/30 10:10:18 chriswhite Exp $
...
DEPEND=">=virtual/python-2.2
	>=x11-libs/cairo-0.2.0
	gtk? ( >=dev-python/pygtk-1.99 )
	svg? ( >=x11-libs/libsvg-cairo-0.1.4 )
