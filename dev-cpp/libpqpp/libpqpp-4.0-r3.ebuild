...
# $Header: /var/cvsroot/gentoo-x86/dev-cpp/libpqpp/libpqpp-4.0-r3.ebuild,v 1.1.1.1 2005/11/30 09:46:21 chriswhite Exp $
...
src_install() {
	...
	sed -i "s|\$(POSTGRES_HOME)/lib|${D}/usr/lib/postgresql|" Makefile || die
