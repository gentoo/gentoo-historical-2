...
S=${WORKDIR}
THEME_URI="mirror://gnome/teams/art.gnome.org/archive/themes/gdm_greeter/"
THEME_URI2="http://www.gnome-look.org/content/files/"
SRC_URI="${THEME_URI}GDM-300-lantueno.tar.gz
	...
	${THEME_URI2}28632-applegentoo.tar.gz
	${THEME_URI2}25716-SleekDragon.tar.gz
