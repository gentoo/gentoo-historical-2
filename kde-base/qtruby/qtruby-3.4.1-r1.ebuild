...
# $Header: /var/cvsroot/gentoo-x86/kde-base/qtruby/qtruby-3.4.1-r1.ebuild,v 1.1.1.1 2005/11/30 10:13:14 chriswhite Exp $
...
PATCHES="$FILESDIR/no-gtk-glib-check.diff $FILESDIR/qtruby-3.4.1-handlers.diff"
