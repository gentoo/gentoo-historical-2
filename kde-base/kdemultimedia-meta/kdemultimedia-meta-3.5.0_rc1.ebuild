...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdemultimedia-meta/kdemultimedia-meta-3.5.0_rc1.ebuild,v 1.1.1.1 2005/11/30 10:13:11 chriswhite Exp $
MAXKDEVER=$PV
...
RDEPEND="arts? ( $(deprange $PV $MAXKDEVER kde-base/artsplugin-akode)
		$(deprange 3.5_beta1 $MAXKDEVER kde-base/artsplugin-audiofile)
		xine? ( $(deprange 3.5.0_beta2 $MAXKDEVER kde-base/artsplugin-xine) )
	...
	$(deprange 3.5.0_beta2 $MAXKDEVER kde-base/kmid)
