...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-startkde/kdebase-startkde-3.4.3.ebuild,v 1.1.1.1 2005/11/30 10:14:11 chriswhite Exp $
...
src_install() {
	# startkde script
	epatch ${FILESDIR}/${PN}-3.4.2-gentoo.patch
	exeinto ${KDEDIR}/bin
	doexe startkde
