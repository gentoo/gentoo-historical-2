...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-meta/kdebase-meta-3.5.0_rc1.ebuild,v 1.1.1.1 2005/11/30 10:13:56 chriswhite Exp $
MAXKDEVER=$PV
...
$(deprange 3.5.0_beta2 $MAXKDEVER kde-base/kcminit)
$(deprange $PV $MAXKDEVER kde-base/kcontrol)
$(deprange 3.5_beta1 $MAXKDEVER kde-base/kdcop)
$(deprange 3.5.0_beta2 $MAXKDEVER kde-base/kdebugdialog)
...
$(deprange 3.5_beta1 $MAXKDEVER kde-base/kreadconfig)
$(deprange $PV $MAXKDEVER kde-base/kscreensaver)
$(deprange 3.5_beta1 $MAXKDEVER kde-base/ksmserver)
$(deprange $PV $MAXKDEVER kde-base/ksplashml)
$(deprange 3.5_beta1 $MAXKDEVER kde-base/kstart)
$(deprange $PV $MAXKDEVER kde-base/ksysguard)
$(deprange 3.5_beta1 $MAXKDEVER kde-base/ksystraycmd)
