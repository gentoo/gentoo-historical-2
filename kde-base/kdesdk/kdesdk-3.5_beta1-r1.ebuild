...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdesdk/kdesdk-3.5_beta1-r1.ebuild,v 1.1.1.1 2005/11/30 10:12:47 chriswhite Exp $
...
src_unpack() {
	...
	# Configure patch.
	epatch "${FILESDIR}/kdesdk-3.5-configure-db.patch"

	# Fix compilation. Applied for rc1.
	epatch "${FILESDIR}/${P}-compile.patch"
	# Fix crash. Applied for rc1.
