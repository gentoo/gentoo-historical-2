...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdenetwork/kdenetwork-3.5.0_rc1.ebuild,v 1.1.1.1 2005/11/30 10:13:33 chriswhite Exp $
...
src_unpack() {
	...
	# Remove for rc2.
	epatch "${FILESDIR}/kopete-3.5.0_rc1-fix.patch"
}
