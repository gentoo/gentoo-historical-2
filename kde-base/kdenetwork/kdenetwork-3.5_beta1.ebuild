...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdenetwork/kdenetwork-3.5_beta1.ebuild,v 1.1.1.1 2005/11/30 10:13:33 chriswhite Exp $
...
src_unpack() {
	...
	# Fix serious problem in Gadu plugin. Applied for rc1.
	epatch "${FILESDIR}/${P}-gadu.patch"
}
