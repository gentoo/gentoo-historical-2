...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdepim-meta/kdepim-meta-3.5.0_rc1.ebuild,v 1.1.1.1 2005/11/30 10:14:10 chriswhite Exp $
MAXKDEVER=$PV
...
RDEPEND="
	...
	$(deprange 3.5.0_beta2 $MAXKDEVER kde-base/kmailcvt)
	...
	$(deprange 3.5.0_beta2 $MAXKDEVER kde-base/libkholidays)
	...
	$(deprange 3.5_beta1 $MAXKDEVER kde-base/libksieve)
	$(deprange 3.5_beta1 $MAXKDEVER kde-base/mimelib)
