...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase/kdebase-3.4.2-r2.ebuild,v 1.1.1.1 2005/11/30 10:13:02 chriswhite Exp $
...
src_unpack() {
	...
	# Avoid name-filter expansion for files that do exists (kde bug 107170). Applied for 3.4.3.
	epatch "${FILESDIR}/kdebase-3.4.2-konqueror-filter.patch"

	# Support for hal-0.5, backported from 3.5 branch.
	epatch "${WORKDIR}/kdebase-3.4-kubuntu-hal.patch"

	# Fix crash related to opengl (kde bug 101154). Applied for 3.4.3.
	epatch "${FILESDIR}/${P}-kinfocenter-opengl-fix.patch"
