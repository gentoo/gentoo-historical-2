...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-i18n/kde-i18n-3.5.0_rc1.ebuild,v 1.1.1.1 2005/11/30 10:14:17 chriswhite Exp $
...
for X in ${LANGS} ; do
	...
	SRC_URI="${SRC_URI} linguas_${X}? ( mirror://kde/unstable/${PV/.0_/-}/src/kde-i18n/kde-i18n-${X}-${PV}.tar.bz2 )"
done
