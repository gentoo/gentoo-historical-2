...
# $Header: /var/cvsroot/gentoo-x86/net-fs/davfs2/davfs2-0.2.4-r2.ebuild,v 1.1.1.1 2005/11/30 09:45:54 chriswhite Exp $
...
src_install() {
	dodir /usr/sbin
	einstall localstatedir=${D}/var/run/mount.davfs sysconfdir=${D}/etc/${PN} || die "einstall failed"
