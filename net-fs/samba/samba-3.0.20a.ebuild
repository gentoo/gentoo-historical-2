...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/samba-3.0.20a.ebuild,v 1.1.1.1 2005/11/30 09:45:51 chriswhite Exp $
...
src_compile() {
	...
	if use ldap; then
		myconf="${myconf} $(use_with ldap) $(use_with kerberos ads) --with-ldapsam"
	else
