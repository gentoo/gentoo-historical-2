...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/samba-3.0.20b.ebuild,v 1.1.1.1 2005/11/30 09:45:51 chriswhite Exp $
...
pkg_setup() {
	...
	ewarn "3.0.20b: New USE flags: ldapsam, swat (default: disabled)"
	ewarn "SQL and XML backends are *experimental*"
	ebeep
	epause
}
