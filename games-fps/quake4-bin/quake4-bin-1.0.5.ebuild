...
# $Header: /var/cvsroot/gentoo-x86/games-fps/quake4-bin/quake4-bin-1.0.5.ebuild,v 1.1.1.1 2005/11/30 09:39:49 chriswhite Exp $
...
src_install() {
	...
	then
		...
		make_desktop_entry quake4 "Quake IV" quake4.bmp
	fi
