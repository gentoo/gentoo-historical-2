...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-headers/linux-headers-2.4.26-r1.ebuild,v 1.1.1.1 2005/11/30 09:49:32 chriswhite Exp $
...
SRC_URI="${KERNEL_URI}"
KEYWORDS="-* ~alpha ~amd64 arm m68k sh ~sparc ~x86"
