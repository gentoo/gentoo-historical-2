...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/suspend2-sources/suspend2-sources-2.6.13.ebuild,v 1.1.1.1 2005/11/30 09:49:30 chriswhite Exp $
...
src_unpack() {
	...
	cp ${FILESDIR}/101-software-suspend-2.2-rc3-for-2.6.13-gcc4.patch \
		${WORKDIR}/${SUSPEND2_SRC}
