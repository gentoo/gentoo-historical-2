...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/uclinux-sources/uclinux-sources-2.4.31_p0.ebuild,v 1.1.1.1 2005/11/30 09:49:25 chriswhite Exp $
...
UC_V="uc${PV/*_p/}"
PATCH_FILE="uClinux-${OKV}-${UC_V}.diff.gz"
