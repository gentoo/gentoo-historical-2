...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.3.8.ebuild,v 1.1.1.1 2005/11/30 09:49:37 chriswhite Exp $
...
SRC_URI="http://dev.gentoo.org/~rocket/genkernel/${P}.tar.bz2
	 ...
	 http://www.kernel.org/pub/linux/libs/klibc/klibc-${VERSION_KLIBC}.tar.gz"
...
src_install() {
	...
	cp ${DISTDIR}/dmraid-${VERSION_DMRAID}.tar.bz2 ${DISTDIR}/LVM2.${VERSION_LVM2}.tgz ${DISTDIR}/device-mapper.${VERSION_DMAP}.tgz ${DISTDIR}/unionfs-${VERSION_UNIONFS}.tar.gz ${DISTDIR}/e2fsprogs-${VERSION_E2FSPROGS}.tar.gz ${DISTDIR}/klibc-${VERSION_KLIBC}.tar.gz ${DISTDIR}/udev-${VERSION_UDEV}.tar.bz2 ${D}/usr/share/genkernel/pkg
}
