...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openvz-sources/openvz-sources-022.044.ebuild,v 1.1.1.1 2005/11/30 09:49:39 chriswhite Exp $
...
SRC_URI="${KERNEL_URI} ${ARCH_URI} \
	http://dev.gentoo.org/~hollow/distfiles/${OVZ_COREPATCH} \
	http://dev.gentoo.org/~phreak/distfiles/${OVZ_COREPATCH}"
