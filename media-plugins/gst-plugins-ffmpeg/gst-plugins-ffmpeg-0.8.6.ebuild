...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-ffmpeg/gst-plugins-ffmpeg-0.8.6.ebuild,v 1.1.1.1 2005/11/30 10:07:29 chriswhite Exp $
...
src_unpack() {
	...
	# bug 103529
	epatch ${FILESDIR}/${PN}-0.8.5-gmake.patch
	./autogen.sh
}
src_compile() {
