...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gdesklets-core/gdesklets-core-0.35.1-r1.ebuild,v 1.1.1.1 2005/11/30 09:40:54 chriswhite Exp $
...
src_install() {
	...
	# Install the new migration tool
	doins ${FILESDIR}/gdesklets-migration-tool
