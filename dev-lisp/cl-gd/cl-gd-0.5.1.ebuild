...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-gd/cl-gd-0.5.1.ebuild,v 1.1.1.1 2005/11/30 10:08:16 chriswhite Exp $
...
src_compile() {
	...
	ld -shared -lgd -lz -lpng -ljpeg -lfreetype -lm cl-gd-glue.o -o cl-gd-glue.so
	rm cl-gd-glue.o
}
