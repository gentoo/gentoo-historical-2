...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-acclaim/cl-acclaim-0.25-r1.ebuild,v 1.1.1.1 2005/11/30 10:08:20 chriswhite Exp $
...
src_unpack() {
	...
	pushd ${S}
	( cat acclaim.asd ppm.asd >acclaim.asd.new \
		&& mv acclaim.asd.new acclaim.asd ) || die
	sed -i 's,:clx,#+cmu :cmucl-clx #-cmu :clx,g' acclaim.asd
}
