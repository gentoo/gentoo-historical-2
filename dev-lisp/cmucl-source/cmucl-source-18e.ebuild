...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cmucl-source/cmucl-source-18e.ebuild,v 1.1.1.1 2005/11/30 10:08:17 chriswhite Exp $

inherit common-lisp

# we are a port of the Debian Project's port
DEB_PV=7
...
S=${WORKDIR}/cmucl-${PV}.orig

src_unpack() {
	unpack ${A}
	patch -p0 <cmucl_${PV}-${DEB_PV}.diff || die
