...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-1.3.33-r12.ebuild,v 1.1.1.1 2005/11/30 10:08:01 chriswhite Exp $
...
pkg_postinst() {
	...
	einfo "has changed to /usr/$(get_libdir)/apache!"
	einfo
