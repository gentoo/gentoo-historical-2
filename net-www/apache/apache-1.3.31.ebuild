...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-1.3.31.ebuild,v 1.1.1.1 2005/11/30 10:08:00 chriswhite Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/patches/${PV}/00_gentoo_base.patch
	epatch ${FILESDIR}/patches/${PV}/00_gentoo_db4_detect.patch
	epatch ${FILESDIR}/patches/${PV}/00_gentoo_apachectl.patch

	if use pam ; then
		epatch ${FILESDIR}/patches/${PV}/00_gentoo_suexec_pam.patch
	fi
