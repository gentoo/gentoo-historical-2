...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/util-vserver/util-vserver-0.30.209.ebuild,v 1.1.1.1 2005/11/30 10:01:50 chriswhite Exp $
...
SRC_URI="http://www.13thfloor.at/~ensc/util-vserver/files/alpha/${P}.tar.bz2 \
	http://dev.gentoo.org/~phreak/${PN}/${P}-gentoo.tar.bz2"
