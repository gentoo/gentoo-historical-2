...
# $Header: /var/cvsroot/gentoo-x86/net-mail/courier-imap/courier-imap-4.0.1-r2.ebuild,v 1.1.1.1 2005/11/30 10:03:29 chriswhite Exp $
...
src_install() {
	...
	# provided by mailbase (see bug #79240)
	rm -f ${D}/etc/pam.d/{imap,pop3}
