...
# $Header: /var/cvsroot/gentoo-x86/dev-ada/adasockets/adasockets-1.8.4.4.ebuild,v 1.1.1.1 2005/11/30 10:00:28 chriswhite Exp $
...
src_install () {
	...
	chmod 0444 ${D}/usr/lib/ada/adalib/adasockets/sockets*.ali

	insinto /usr/lib/ada/adainclude/adasockets
	doins src/sockets*.ad[sb]
