...
# $Header: /var/cvsroot/gentoo-x86/app-backup/tsm/tsm-6.2.2.0.ebuild,v 1.2 2010/12/20 17:25:25 dertobi123 Exp $
...
src_install() {
	...
	for i in libgpfs.so libdmapi.so libha_gs_r.so libct_cu.so; do
