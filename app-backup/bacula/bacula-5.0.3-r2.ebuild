...
# $Header: /var/cvsroot/gentoo-x86/app-backup/bacula/bacula-5.0.3-r2.ebuild,v 1.1 2010/12/29 10:35:07 tomjbe Exp $
...
pkg_setup() {
	...
	if use bacula-clientonly && use static && use qt4; then
		ewarn
		ewarn "Building statical linked 'bat' is not supported. Ignorig it."
		ewarn
	fi
