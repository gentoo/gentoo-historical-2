...
# $Header: /var/cvsroot/gentoo-x86/scripts/bootstrap.sh,v 1.1.1.1 2005/11/30 10:02:44 chriswhite Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/bootstrap.sh,v 1.1.1.1 2005/11/30 10:02:44 chriswhite Exp $"
			cvsver=${cvsver##*,v }
