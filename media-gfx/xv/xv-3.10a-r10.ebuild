...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/xv/xv-3.10a-r10.ebuild,v 1.1.1.1 2005/11/30 09:37:14 chriswhite Exp $
...
src_unpack() {
	...
	# security issue with malformed filenames #83686
	epatch ${FILESDIR}/${PN}-filename-format-string.diff || die
}
