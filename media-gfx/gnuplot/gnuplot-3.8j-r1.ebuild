...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gnuplot/gnuplot-3.8j-r1.ebuild,v 1.1.1.1 2005/11/30 09:37:23 chriswhite Exp $
...
src_unpack() {
	unpack ${A}
	use amd64 && (cd ${S} ; epatch ${FILESDIR}/gnuplot-3.8j-amd64.diff)
}
