...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/blender/blender-2.34-r1.ebuild,v 1.1.1.1 2005/11/30 09:37:44 chriswhite Exp $
...
src_unpack() {
	...
	chmod 755 bmake
	rm -fR include
	ln -s ${S}/source/blender/blenpluginapi include
}
...
#	einstall || die
	...
	cp -aR	${S}/release/{bpydata,plugins,scripts} ${D}/usr/lib/${PN}
