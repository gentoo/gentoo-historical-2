...
# $Header: /var/cvsroot/gentoo-x86/games-emulation/xmame/xmame-0.99-r1.ebuild,v 1.1.1.1 2005/11/30 09:50:27 chriswhite Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-mcr3.patch #102987
