...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/evolution-2.0.3-r2.ebuild,v 1.1.1.1 2005/11/30 09:49:56 chriswhite Exp $
...
src_unpack() {
	...
	# bug #80376 -- allow plain text passwords
	epatch ${FILESDIR}/${PN}_mail-account-gui_authtype.diff
}
