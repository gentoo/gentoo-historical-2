...
# $Header: /var/cvsroot/gentoo-x86/mail-client/squirrelmail/squirrelmail-1.4.5-r1.ebuild,v 1.1.1.1 2005/11/30 09:49:44 chriswhite Exp $
...
src_unpack() {
	...
	# Bug #108394
	epatch ${FILESDIR}/${PN}-1.4.5-array_shift.patch
