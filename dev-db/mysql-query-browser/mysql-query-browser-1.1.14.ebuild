...
# $Header: /var/cvsroot/gentoo-x86/dev-db/mysql-query-browser/mysql-query-browser-1.1.14.ebuild,v 1.1.1.1 2005/11/30 10:11:40 chriswhite Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/1.1.12-optional-4.1-support.patch
}
