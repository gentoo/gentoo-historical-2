...
# $Header: /var/cvsroot/gentoo-x86/dev-db/pgcluster/pgcluster-1.3.0b.ebuild,v 1.1.1.1 2005/11/30 10:11:23 chriswhite Exp $
...
MY_PV=${PV/_/}
MY_P=${PN}-${MY_PV}
SRC_URI="http://pgfoundry.org/frs/download.php/181/${P}.tar.gz"
