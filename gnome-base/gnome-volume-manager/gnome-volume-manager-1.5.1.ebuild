...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-volume-manager/gnome-volume-manager-1.5.1.ebuild,v 1.1.1.1 2005/11/30 10:09:04 chriswhite Exp $

inherit eutils gnome2

DESCRIPTION="Daemon that enforces volume-related policies"
HOMEPAGE="http://www.gnome.org/"
SRC_URI="http://primates.ximian.com/~fejj/gvm//${P}.tar.gz
