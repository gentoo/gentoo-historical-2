...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.12.1.ebuild,v 1.1.1.1 2005/11/30 10:09:13 chriswhite Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=x11-themes/gnome-themes-2.12.1

	>=x11-themes/gtk-engines-2.6.5
	>=x11-themes/gnome-backgrounds-2.12.1
	...
	>=gnome-extra/gnome-games-2.12.1
	>=gnome-base/librsvg-2.12.4

	>=gnome-extra/gnome-system-monitor-2.12.1
	>=gnome-base/libgtop-2.12.0

	>=x11-libs/startup-notification-0.8

	>=gnome-extra/gnome2-user-docs-2.8.1
	>=gnome-extra/yelp-2.12.1
	>=gnome-extra/zenity-2.12.1

	>=net-analyzer/gnome-netstatus-2.12.0
	>=net-analyzer/gnome-nettool-1.4.1

	cdr? ( >=gnome-extra/nautilus-cd-burner-2.12.1 )
	dvdr? ( >=gnome-extra/nautilus-cd-burner-2.12.1 )
	...
	accessibility? (
		...
		>=app-accessibility/gnome-speech-0.3.8
		>=app-accessibility/gok-1.0.5
		>=app-accessibility/gnopernicus-0.11.7 )"
