...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-session/gnome-session-2.10.0-r3.ebuild,v 1.1.1.1 2005/11/30 10:09:12 chriswhite Exp $
...
src_unpack() {
	...
	# Remove smproxy. See bug #98646.
	epatch ${FILESDIR}/${P}-no_smproxy.patch
