...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/glibc-2.3.5.ebuild,v 1.1.1.1 2005/11/30 09:39:27 chriswhite Exp $
...
PDEPEND="amd64? ( multilib? ( =app-emulation/emul-linux-x86-glibc-${PVR} ) )"
