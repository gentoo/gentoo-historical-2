...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/misdn/misdn-20051017.ebuild,v 1.1.1.1 2005/11/30 09:46:07 chriswhite Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	sed -i "s:pci_find_subsys:pci_get_subsys:g" hfc_multi.c
	sed -i "s:PCI_DEVICE_ID_SITECOM_DC105:PCI_DEVICE_ID_SITECOM_DC105V2:" hfc_pci.c
}
