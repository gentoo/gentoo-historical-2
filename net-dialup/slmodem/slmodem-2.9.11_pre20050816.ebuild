...
SRC_URI="http://linmodems.technion.ac.il/packages/smartlink/snapshots/${P/_pre/-}.tar.gz
...
pkg_setup() {
	MODULE_NAMES="ungrab-winmodem(:${WORKDIR}/ungrab-winmodem) slamr(net:${S}/drivers)"
	if use usb; then
...
src_unpack() {
	...
	epatch ${FILESDIR}/slmodem-class-simple-to-class.diff
