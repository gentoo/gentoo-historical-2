...
# $Header: /var/cvsroot/gentoo-x86/net-misc/rsync/rsync-2.6.6-r1.ebuild,v 1.1.1.1 2005/11/30 09:54:28 chriswhite Exp $
...
src_unpack() {
	...
	cd "${S}"
	if use acl ; then
		epatch patches/acls.diff "${FILESDIR}"/${P}-acls.patch
