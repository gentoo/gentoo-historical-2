...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk-oh323/asterisk-oh323-0.7.3.ebuild,v 1.1.1.1 2005/11/30 09:54:31 chriswhite Exp $
...
src_unpack() {
	...
	# additional patch for 1.2.X's asterisk.h 
	epatch ${FILESDIR}/${PN}-0.7.3-gentoo.diff
