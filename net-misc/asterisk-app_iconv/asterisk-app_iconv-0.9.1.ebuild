...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk-app_iconv/asterisk-app_iconv-0.9.1.ebuild,v 1.1.1.1 2005/11/30 09:54:57 chriswhite Exp $
...
src_unpack() {
	...
	cd ${S}
	# use asterisk-config...
	epatch ${FILESDIR}/${MY_PN}-0.9.1-astcfg.diff
}
