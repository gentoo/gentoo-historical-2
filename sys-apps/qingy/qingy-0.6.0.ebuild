...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/qingy/qingy-0.6.0.ebuild,v 1.1.1.1 2005/11/30 09:56:13 chriswhite Exp $
...
IUSE="crypt emacs gpm pam static"

DEPEND=">=dev-libs/DirectFB-0.9.18
	crypt? ( >=dev-libs/openssl-0.9.7e )
	emacs? ( virtual/emacs )
