...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/busybox/busybox-1.01.ebuild,v 1.1.1.1 2005/11/30 09:56:12 chriswhite Exp $
...
SRC_URI="${SRC_URI} mirror://gentoo/${PN}-1.00-e2fsprogs.patch.bz2"
...
src_unpack() {
	...
	epatch "${WORKDIR}"/${PN}-1.00-e2fsprogs.patch
