...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/powerpc-utils/powerpc-utils-1.1.3-r12.ebuild,v 1.1.1.1 2005/11/30 09:56:25 chriswhite Exp $
...
src_install() {
	into /usr
	dosbin nvsetenv trackpad clock mousemode backlight nvsetvol fblevel fnset || die
