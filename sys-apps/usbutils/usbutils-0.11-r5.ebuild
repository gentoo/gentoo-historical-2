...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/usbutils/usbutils-0.11-r5.ebuild,v 1.1.1.1 2005/11/30 09:56:44 chriswhite Exp $
...
src_unpack() {
	...
	use ppc64 && epatch ${FILESDIR}/0.11/ppc64-usbutils-kheaderfix.patch

	# Fix endian-issues
	epatch "${FILESDIR}/0.11/lsusb-endian.patch"

	epatch "${FILESDIR}"/usbutils-0.11-fix-usb-ids-man-page-ref.patch #62786
}
