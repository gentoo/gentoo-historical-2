...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.12.0_pre10-r1.ebuild,v 1.1.1.1 2005/11/30 09:56:50 chriswhite Exp $
...
src_unpack() {
	...
	# Fix bugs 112031, 112049
	# Allows wpa_supplicant to specify config file and --pidfile
	epatch "${FILESDIR}/${P}-svn-1611.patch"
