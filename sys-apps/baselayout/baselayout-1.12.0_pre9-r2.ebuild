...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.12.0_pre9-r2.ebuild,v 1.1.1.1 2005/11/30 09:56:53 chriswhite Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}"-1.12.0-split-out-udev.patch
	# Stupid Roy - define 4 preferred modules but only count 3
	# This fixes that, #108960!
	epatch "${FILESDIR}/${P}-npref.patch"
