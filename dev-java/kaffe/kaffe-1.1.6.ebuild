...
# $Header: /var/cvsroot/gentoo-x86/dev-java/kaffe/kaffe-1.1.6.ebuild,v 1.1.1.1 2005/11/30 09:47:28 chriswhite Exp $
...
#Add support after bug 107432 is fixed for all keyworded arches.
