...
# $Header: /var/cvsroot/gentoo-x86/dev-java/jgoodies-animation/jgoodies-animation-1.1.3.ebuild,v 1.1.1.1 2005/11/30 09:47:46 chriswhite Exp $
...
src_install() {
	java-pkg_newjar animation-${PV}.jar animation.jar
