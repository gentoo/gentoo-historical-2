...
# $Header: /var/cvsroot/gentoo-x86/dev-java/castor/castor-0.9.7.ebuild,v 1.1.1.1 2005/11/30 09:47:14 chriswhite Exp $
...
src_unpack() {
	...
	cd ${S}/src
	#This patch is taken care of by axxo-overlay and 1.5 is not
	#supported.
