...
# $Header: /var/cvsroot/gentoo-x86/www-client/kazehakase/kazehakase-0.3.1.ebuild,v 1.1.1.1 2005/11/30 09:52:11 chriswhite Exp $

IUSE="migemo estraier thumbnail firefox ssl"

DESCRIPTION="a browser with gecko engine like Epiphany or Galeon."
SRC_URI="mirror://sourceforge.jp/${PN}/16705/${P}.tar.gz"
...
src_compile(){
	...
	# econf `use_enable migemo` `use_enable ssl` --with-gecko-engine=${geckoengine} || die
