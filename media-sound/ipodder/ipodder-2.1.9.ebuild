...
# $Header: /var/cvsroot/gentoo-x86/media-sound/ipodder/ipodder-2.1.9.ebuild,v 1.1 2005/11/30 09:38:24 chriswhite Exp $
...
src_install() {
	...
	# Fix perms
	fperms 644 ${D}/opt/iPodder/ipodder/players.py
