...
# $Header: /var/cvsroot/gentoo-x86/media-sound/sound-juicer/sound-juicer-2.12.2-r1.ebuild,v 1.1.1.1 2005/11/30 09:38:21 chriswhite Exp $
...
src_unpack() {
	...
	# fix crash for going to edit -> preferences, #108895
	epatch ${FILESDIR}/${P}-file-chooser-3.patch
}
