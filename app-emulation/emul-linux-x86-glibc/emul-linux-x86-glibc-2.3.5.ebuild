...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/emul-linux-x86-glibc/emul-linux-x86-glibc-2.3.5.ebuild,v 1.1.1.1 2005/11/30 10:08:40 chriswhite Exp $
...
SRC_URI="!nptl? ( ${BASE_URI}/${P}-lt.tar.bz2 )
	 nptl? ( !nptlonly? ( ${BASE_URI}/${P}-nptl.tar.bz2 ) )
	 nptl? ( nptlonly? ( ${BASE_URI}/${P}-nptlonly.tar.bz2 ) )"
