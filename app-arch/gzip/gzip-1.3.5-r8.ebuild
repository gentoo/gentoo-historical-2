...
# $Header: /var/cvsroot/gentoo-x86/app-arch/gzip/gzip-1.3.5-r8.ebuild,v 1.1.1.1 2005/11/30 10:00:33 chriswhite Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-huft-build-return-fix.patch
