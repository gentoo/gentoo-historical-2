...
# $Header: /var/cvsroot/gentoo-x86/app-arch/star/star-1.5_alpha50.ebuild,v 1.1.1.1 2005/11/30 10:00:38 chriswhite Exp $
...
src_install() {
	...
	# finally, remove /usr/bin/tar #33119
	rm ${D}/usr/bin/tar

	dosym ${D}/usr/bin/star /usr/bin/ustar
