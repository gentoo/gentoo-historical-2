...
# $Header: /var/cvsroot/gentoo-x86/dev-php/jpgraph/jpgraph-1.19-r1.ebuild,v 1.1.1.1 2005/11/30 09:47:51 chriswhite Exp $
...
pkg_setup() {
	...
	if ! built_with_use =`best_version =dev-php/php-4*` gd ; then
		eerror "Please build dev-php/php with the"
		eerror "'gd' USE flag turned on."
